...
const OIL_GROUPS = [
  {
    title: "Engine",
    fields: [
      ["Engine (REM):", "engineRem"],
      ["Engine (ADD):", "engineAdd"],
      ["Engine (TOT):", "engineTot"],
    ],
  },
  {
    title: "M/R G/Box",
    fields: [
      ["M/R G/Box (REM):", "mrGboxRem"],
      ["M/R G/Box (ADD):", "mrGboxAdd"],
      ["M/R G/Box (TOT):", "mrGboxTot"],
    ],
  },
  {
    title: "T/R G/Box",
    fields: [
      ["T/R G/Box (REM):", "trGboxRem"],
      ["T/R G/Box (ADD):", "trGboxAdd"],
      ["T/R G/Box (TOT):", "trGboxTot"],
    ],
  },
];
