...
const accessLevelData = [
  {
    ...
    selectable: false,
    children: [
      { title: "Superadmin", value: "Superadmin_job" },
  ...
  },
  {
    ...
    selectable: false,
    children: [
      { title: "Superadmin", value: "Superadmin_access" }, // Note: unique value if overlaps with jobTitle
  ...
  useEffect(() => {
    ...
    if (treeValue) {
      filtered = filtered.filter((u) => {
        if (treeValue === "Superadmin_job") return u.jobTitle === "Superadmin";
        if (treeValue === "Superadmin_access") return u.access === "Superadmin";
