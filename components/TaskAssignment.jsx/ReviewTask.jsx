    ...
    <Modal visible={visible} animationType="fade" transparent>
      <View style={styles.alertOverlay}>
        <View style={[styles.alertContainer, { width: 400, padding: 24 }]}>
          <Text style={[styles.alertTitle, { fontSize: 24, marginBottom: 20, textAlign: "center" }]}>
          ...
          {mode === "return" && (
            <>
              <Text style={{ fontSize: 14, color: COLORS.grayDark, marginBottom: 8 }}>
                Leave a note...
              </Text>
              <TextInput
                style={{
          ...
          <View style={{
            ...
            >
              <Text style={{ fontSize: 24, fontWeight: "bold", color: COLORS.grayDark }}>
                X
              </Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={{ flexDirection: "row", justifyContent: "flex-end", gap: 12 }}>
            ...
            <Button
              ...
              buttonStyle={[mode === "return" ? styles.dangerBtn : styles.primaryAlertBtn, { width: 100 }]}
