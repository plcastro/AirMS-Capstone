...
export default function AddComponent({ visible, onClose, onComponentAdded }) {
  ...
  const handleConfirmSave = async () => {
    ...
    // send to API or add to local state
    resetForm();
    onClose();
  };
  ...
  const Content = (
    <View style={styles.addUserOverlay}>
      ...
      >
        <Text style={styles.addUserTitle}>ADD COMPONENT</Text>
