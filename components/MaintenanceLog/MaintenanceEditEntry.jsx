...
export default function EditEntry({ visible, entry, onClose, onSave }) {
  ...
  const handleSave = () => {
    if (
      !formData.correctiveActionDone ||
      formData.correctiveActionDone === "N/A"
    ) {
    ...
    if (
      formData.dateDefectRectified &&
      formData.dateDefectRectified !== "N/A"
    ) {
      ...
      <Modal transparent visible={visible} animationType="fade">
        <View style={styles.newEntryOverlay}>
          <View style={styles.newEntryCard}>
            <Text style={styles.newEntryTitle}>Edit Maintenance Entry</Text>
            ...
            <ScrollView keyboardShouldPersistTaps="handled">
              ...
              <View style={styles.newEntryField}>
                <Text style={styles.newEntryLabel}>
