...
export default function PostInspectionModalStation2({ formData, updateForm, isEditable = true }) {
  ...
  const station2Items = [
    { 
      ...
      checks: [
        { subKey: "condition", label: "Condition, no crack on external jettison lever" }
      ]
    },
    { 
    ...
    { 
      ...
      title: "Landing gear", 
      checks: [
        { subKey: "condition", label: "Condition of crosstubes, skids, wear resistant plates, footstep attachment" }
      ]
    },
    { 
      ...
      checks: [
        { subKey: "condition", label: "Condition, blanking removed or fitted as necessary" }
      ]
    },
    { 
      ...
      title: "OAT probe", 
      checks: [
        { subKey: "condition", label: "Condition, attachment" }
      ]
    },
    { 
      ...
      checks: [
        { subKey: "condition", label: "Condition" }
      ]
    },
    { 
      key: "station2_lights", 
    ...
    { 
      ...
      title: "Fuel tank", 
      checks: [
        { subKey: "condition", label: "Filler plug closed - Tank sump drained (before first flight of the day and any aircraft displacement)" }
      ]
    },
    { 
    ...
    { 
      ...
      checks: [
        { subKey: "harness", label: "Harness condition" }
      ]
    },
    { 
      key: "station2_elt", 
      title: "ELT", 
      checks: [
        { subKey: "condition", label: "Condition, security, \"ARM\" or \"OFF\" as necessary" }
      ]
    },
    { 
    ...
    { 
      ...
      checks: [
        { subKey: "opening", label: "Opening, condition of locking devices, no abnormal freeplay" }
      ]
    },
    { 
      ...
      title: "Upper cowling", 
      checks: [
        { subKey: "security", label: "Security" }
      ]
    },
    { 
      key: "station2_mgb", 
    ...
    { 
      ...
      checks: [
        { subKey: "condition", label: "Condition, attachment points, pipes, no leaks" }
      ]
    },
    { 
      key: "station2_servos", 
      title: "Servos", 
      checks: [
        { subKey: "security", label: "Security, no leaks or cracks" }
      ]
    },
    { 
    ...
    { 
      ...
      checks: [
        { subKey: "safety", label: "Closed and secured" }
      ]
    },
  ];
        ...
        {item.checks.map((check) => {
          ...
          return (
            ...
            >
              ...
              <Text style={{ 
                fontSize: 16, // Matched to UI standard
    ...
    <View>
      ...
      <View style={{ 
            ...
            >
              <View
                style={{
                  ...
                  borderWidth: 2,
                  borderColor: COLORS.primaryLight, // Matched to always be primaryLight
                  backgroundColor: station2SelectAll ? COLORS.primaryLight : "transparent",
                  justifyContent: "center",
                  alignItems: "center",
                  marginRight: 12,
                }}
        ...
        <View style={{ paddingHorizontal: 16, paddingTop: 16, paddingBottom: 8 }}>
          {station2Items.map((item, index) => renderItemWithChecks(index, item))}
        </View>
      </View>
    </View>
  );
