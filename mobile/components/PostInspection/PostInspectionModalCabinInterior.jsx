...
export default function PostInspectionModalCabinInterior({ formData, updateForm, isEditable = true }) {
  ...
  const cabinItems = [
    { 
      ...
      title: "Cabin", 
      checks: [
        { subKey: "cleanliness", label: "General cleanliness" }
      ]
    },
    { 
      key: "cabin_seats", 
      title: "Seats", 
      checks: [
        { subKey: "condition", label: "Condition, attachment points" }
      ]
    },
    { 
    ...
    { 
      ...
      checks: [
        { subKey: "condition", label: "Secured - Checked" }
      ]
    },
    { 
    ...
    { 
      ...
      checks: [
        { subKey: "on", label: "ON, check battery voltage" }
      ]
    },
    { 
      key: "cabin_vemd", 
      title: "VEMD", 
      checks: [
        { subKey: "flightReport", label: "Check flights of the day report pages data (MAIN mode, FLIGHT REPORT page)" },
        { subKey: "flightTimes", label: "VEMD flight times" },
        { subKey: "cycles", label: "Ng and Nf cycles: check written in white characters and above 0" },
            ...
            >
              <View
                style={{
                  ...
                  borderWidth: 2,
                  borderColor: COLORS.primaryLight, // Matched to always be primaryLight
                  backgroundColor: cabinSelectAll ? COLORS.primaryLight : "transparent",
                  justifyContent: "center",
                  alignItems: "center",
                  marginRight: 12,
                }}
