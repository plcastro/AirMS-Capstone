...
export default function PostInspectionModalMainRotor({ formData, updateForm, isEditable = true }) {
  ...
  const mainRotorItems = [
    { 
      ...
      checks: [
        { subKey: "condition", label: "Security, general condition" }
      ]
    },
    { 
      ...
      title: "STARFLEX star", 
      checks: [
        { subKey: "condition", label: "No delamination, (splinters)" }
      ]
    },
    { 
      ...
      title: "Star recesses", 
      checks: [
        { subKey: "condition", label: "No cracks" }
      ]
    },
    { 
      ...
      checks: [
        { subKey: "condition", label: "No elastomeric defects, separation, scratches, blisters, extrusion or cracks (other than minor and non evolving surface defects)" }
      ]
    },
    { 
      ...
      checks: [
        { subKey: "condition", label: "No debris nor free-play" }
      ]
    },
    { 
      ...
      checks: [
        { subKey: "condition", label: "No space between adhesive bead and bush" }
      ]
    },
    { 
      ...
      checks: [
        { subKey: "condition", label: "Security" }
      ]
    },
    { 
      ...
      title: "Blades", 
      checks: [
        { subKey: "condition", label: "Security, general coating, tabs, and polyurethane protection condition (visual check for debonding, scratches, cracks, impacts and distortions). No erosion holes on leading edge steel strip, no gaps nor impacts" }
      ]
    },
    { 
    ...
    { 
      ...
      checks: [
        { subKey: "opening", label: "Opening, condition of locking systems, no abnormal freeplay" }
      ]
    },
    { 
      ...
      checks: [
        { subKey: "cleanliness", label: "Cleanliness" }
      ]
    },
    { 
    ...
    { 
      ...
      checks: [
        { subKey: "condition", label: "Condition, no leak, fan security, fan blades condition" }
      ]
    },
    { 
    ...
    { 
      ...
      checks: [
        { subKey: "condition", label: "Security, pipes condition, check for leaks, filter clogging indicator retracted" }
      ]
    },
    { 
      ...
      checks: [
        { subKey: "condition", label: "Level, no leak" }
      ]
    },
    { 
    ...
    { 
      ...
      title: "Landing gear", 
      checks: [
        { subKey: "condition", label: "Condition of cross-tubes, skids, wear resistant plates, footstep security" }
      ]
    },
    { 
    ...
    { 
      ...
      checks: [
        { subKey: "condition", label: "Condition, security, locking, no abnormal freeplay" }
      ]
    },
    { 
      ...
      checks: [
        { subKey: "condition", label: "Condition, no crack" }
      ]
    },
  ];
            ...
            >
              <View
                style={{
                  ...
                  backgroundColor: mainRotorSelectAll ? COLORS.primaryLight : "transparent",
                  justifyContent: "center",
                  alignItems: "center",
                  marginRight: 12,
                }}
