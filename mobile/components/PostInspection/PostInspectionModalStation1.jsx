...
export default function PostInspectionModalStation1({ formData, updateForm, isEditable = true }) {
  ...
  const station1Items = [
    ...
    { 
      ...
      checks: [
        { subKey: "condition", label: "Condition, blanking cap removed or fitted as necessary" }
      ]
    },
    { 
    ...
    { 
      ...
      checks: [
        { subKey: "condition", label: "Condition, no obstruction or debris, blanking removed or fitted as necessary" }
      ]
    },
  ];
    ...
    <View>
      ...
      <View style={{ 
        ...
        <View style={{ paddingHorizontal: 16, paddingTop: 16, paddingBottom: 8 }}>
          {station1Items.map((item, index) => renderItemWithChecks(index, item))}
        </View>
      </View>
    </View>
  );
