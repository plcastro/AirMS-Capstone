      ...
      <View style={{ flex: 1, justifyContent: "center", padding: 18, backgroundColor: "rgba(0,0,0,0.35)" }}>
        <View style={{ maxHeight: "78%", borderRadius: 14, padding: 16, backgroundColor: COLORS.white }}>
          <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 12 }}>
            <AppText style={{ flex: 1, fontSize: 18, fontWeight: "900", color: COLORS.black }}>Members</AppText>
            <TouchableOpacity
              onPress={onClose}
          ...
          <AppText numberOfLines={1} style={{ marginBottom: 8, fontSize: 12, color: COLORS.grayDark }}>
