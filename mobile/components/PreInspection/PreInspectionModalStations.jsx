...
export default function PreInspectionModalStations({ formData, updateForm, isEditable = true }) {
  const [station1SelectAll, setStation1SelectAll] = useState(false);
  const [station2SelectAll, setStation2SelectAll] = useState(false);

  const station1Items = [
    { key: "station1_transparentPanels", title: "Transparent Panels", label: "Condition - Cleanliness" },
    { key: "station1_engineOilCooler", title: "Engine oil cooler air inlet", label: "Check no obstruction nor debris" },
    { key: "station1_sideSlipIndicator", title: "Side slip indicator", label: "Condition" },
  ...
  const station2Items = [
    ...
    { key: "station2_rearDoor", title: "Rear door", label: "Condition, closed, or opened lock (sliding door)" },
    ...
    { key: "station2_fuelTank", title: "Fuel tank and system", label: "Filler plug closed, Tank sump drained" },
    ...
    { key: "station1_landingGear", title: "Landing gear and footstep", label: "Secure - Visual Check" },
    ...
    { key: "station1_mainRotor", title: "Main rotor head blades", label: "Visual inspection, no impact" },
    { key: "station1_engineAirIntake", title: "Engine air intake", label: "Clear (water, snow foreign object)" },
            ...
            >
              <View
                style={{
                  ...
                  borderWidth: 2,
                  borderColor: COLORS.primaryLight,
                  backgroundColor: station1SelectAll ? COLORS.primaryLight : "transparent",
                  justifyContent: "center",
                  alignItems: "center",
                  marginRight: 12,
                }}
