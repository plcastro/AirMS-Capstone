...
export default function PreInspectionModalSling({ formData, updateForm, isEditable = true }) {
  ...
  const station3Items = [
    ...
    { key: "station3_tailBoom", title: "Tail boom, antennas", label: "Condition - Fairings fasteners locked" },
    { key: "station3_stabilizer", title: "Stabilizer, fin, external lights", label: "General condition" },
    { key: "station3_tailRotorGuard", title: "Tail rotor guard (if fitted)", label: "Condition, attachment" },
            ...
            >
              <View
                style={{
                  ...
                  borderWidth: 2,
                  borderColor: COLORS.primaryLight,
                  backgroundColor: slingSelectAll ? COLORS.primaryLight : "transparent",
                  justifyContent: "center",
                  alignItems: "center",
                  marginRight: 12,
                }}
